...
try:
    fullversion = version("diffpy.distanceprinter")
except Exception:
...
modindex_common_prefix = ["diffpy.distanceprinter"]
...
html_context = {
    "display_github": True,
    "github_user": "diffpy",
    "github_repo": "diffpy.distanceprinter",
    "github_version": "main",
...
basename = "diffpy.distanceprinter".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "diffpy.distanceprinter.tex",
        "diffpy.distanceprinter Documentation",
        ab_authors,
        "manual",
    ),
]
